...
To develop a machine learning model using Random Forest Regressor to predict multiple weather parameters such as temperature, PM2.5 (air pollution), and solar radiation based on historical weather data and engineered features like time and lag variables.
The dataset contains time-based environmental readings such as humidity, pressure, wind speed, illumination, CO₂ levels and timestamps.
...
## Output:
<img width="1370" height="588" alt="Screenshot 2026-03-17 190929" src="https://github.com/user-attachments/assets/f5bc84c9-af03-43e1-aa39-3179811d85c0" />
<img width="1371" height="461" alt="Screenshot 2026-03-17 190958" src="https://github.com/user-attachments/assets/667c038e-6d6b-45e8-a1c0-ff013ef41e87" />
<img width="1360" height="604" alt="Screenshot 2026-03-17 191025" src="https://github.com/user-attachments/assets/a7fd528a-047f-4050-ac55-cb68a44dd009" />


## Result:
Thus the python program to predict daily temperature , PM2.5 pollution level and Energy based on environmental sensor data using Random Forest Algorithm has verified successfully.
